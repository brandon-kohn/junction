...
#ifndef JUNCTION_EXTRA_IMPL_MAPADAPTER_GRAMPA_H
#define JUNCTION_EXTRA_IMPL_MAPADAPTER_GRAMPA_H
...
public:
    ...
    typedef ConcurrentMap_Grampa<u32, void*> Map;
...
#endif // JUNCTION_EXTRA_IMPL_MAPADAPTER_GRAMPA_H
